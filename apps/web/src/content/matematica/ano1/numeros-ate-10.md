...
```quiz
{
  ...
  "questions": [
    { "q": "Quantos balões há?", "emoji": "🎈🎈🎈", "layout": "grid",
      "options": [ { "t": "2", "emoji": "2️⃣", "feedback": "2 é a menos: ficou um balão por contar. Aponta com o dedo um a um — 1, 2, 3 — e dá 3.", "tag": "contagem-numeros" }, { "t": "3", "emoji": "3️⃣", "correct": true }, { "t": "5", "emoji": "5️⃣", "feedback": "5 é demais: contaste balões a mais. Aponta com o dedo — 1, 2, 3 — e dá 3.", "tag": "contagem-numeros" } ],
      "explain": "Conta: 1, 2, 3! São 3 balões." },
    { "q": "Quantos gatinhos vês?", "emoji": "🐱🐱🐱🐱🐱", "layout": "grid",
      "options": [ { "t": "4", "emoji": "4️⃣", "feedback": "4 é a menos: saltaste um gatinho. Aponta um a um até ao fim — dá 5, uma mão cheia!", "tag": "contagem-numeros" }, { "t": "5", "emoji": "5️⃣", "correct": true }, { "t": "6", "emoji": "6️⃣", "feedback": "6 é demais: contaste um gatinho a mais. Aponta um a um — são só 5, uma mão cheia!", "tag": "contagem-numeros" } ],
      "explain": "Uma mão cheia: 5 gatinhos! ✋" },
    { "q": "Quantos dedos tem uma mão?", "emoji": "✋", "layout": "grid",
      "options": [ { "t": "5", "emoji": "5️⃣", "correct": true }, { "t": "3", "emoji": "3️⃣", "feedback": "3 é a menos. Abre a mão e conta os dedos: 1, 2, 3, 4, 5 — são 5!", "tag": "contagem-numeros" }, { "t": "10", "emoji": "🔟", "feedback": "10 são os dedos das DUAS mãos. Uma mão sozinha tem só 5 dedos.", "tag": "contagem-numeros" } ],
      "explain": "Uma mão tem 5 dedos." },
    { "q": "Que número vem depois do 4?", "layout": "grid",
      "options": [ { "t": "3", "emoji": "3️⃣", "feedback": "3 vem ANTES do 4, não depois. Depois é mais um: 4 e mais 1 dá 5.", "tag": "numero-seguinte-anterior" }, { "t": "5", "emoji": "5️⃣", "correct": true }, { "t": "6", "emoji": "6️⃣", "feedback": "6 está longe demais: saltaste o 5. Depois do 4 vem logo o 5, que é mais um.", "tag": "numero-seguinte-anterior" } ],
      "explain": "Depois do 4 vem o 5. É sempre mais um!" },
    { "q": "Quantas estrelas?", "emoji": "⭐⭐", "layout": "grid",
      "options": [ { "t": "1", "emoji": "1️⃣", "feedback": "1 é a menos: há mais uma estrela. Conta: 1, 2 — são 2!", "tag": "contagem-numeros" }, { "t": "2", "emoji": "2️⃣", "correct": true }, { "t": "4", "emoji": "4️⃣", "feedback": "4 é demais: só há 2 estrelas. Conta com o dedo: 1, 2.", "tag": "contagem-numeros" } ],
      "explain": "1, 2 estrelas!" },
    { "q": "Qual é o número MAIOR?", "layout": "grid",
      "options": [ { "t": "8", "emoji": "8️⃣", "correct": true }, { "t": "3", "emoji": "3️⃣", "feedback": "O 3 está mais atrás na fila dos números, por isso é mais pequeno. O 8 está mais à frente: é o maior.", "tag": "comparar-numeros" }, { "t": "1", "emoji": "1️⃣", "feedback": "O 1 é o mais pequeno de todos, está no início da fila. O maior aqui é o 8.", "tag": "comparar-numeros" } ],
      "explain": "O 8 está mais à frente na fila, por isso é o maior." },
    { "q": "Quantos corações vês?", "emoji": "❤️❤️❤️❤️", "layout": "grid",
      "options": [ { "t": "4", "emoji": "4️⃣", "correct": true }, { "t": "3", "emoji": "3️⃣", "feedback": "3 é a menos: ficou um coração por contar. Aponta um a um — 1, 2, 3, 4 — dá 4.", "tag": "contagem-numeros" }, { "t": "5", "emoji": "5️⃣", "feedback": "5 é demais: só há 4 corações. Conta com o dedo: 1, 2, 3, 4.", "tag": "contagem-numeros" } ],
      "explain": "Conta: 1, 2, 3, 4 corações!" },
    { "q": "Quantos dedos têm as DUAS mãos?", "emoji": "🙌", "layout": "grid",
      "options": [ { "t": "10", "emoji": "🔟", "correct": true }, { "t": "5", "emoji": "5️⃣", "feedback": "5 são os dedos de UMA mão só. As duas mãos juntas têm 5 + 5 = 10.", "tag": "contagem-numeros" }, { "t": "2", "emoji": "2️⃣", "feedback": "2 são as mãos, não os dedos! Os dedos das duas mãos são 5 + 5 = 10.", "tag": "contagem-numeros" } ],
      "explain": "5 + 5 = 10. Duas mãos têm 10 dedos!" },
    { "q": "Se não há nada para contar, o número é…", "layout": "grid",
      "options": [ { "t": "0 (zero)", "emoji": "⭕", "correct": true }, { "t": "1", "emoji": "1️⃣", "feedback": "1 quer dizer que há uma coisa. Se não há NADA, o número é o 0 (zero).", "tag": "vocabulario-numero" }, { "t": "10", "emoji": "🔟", "feedback": "10 são muitas coisas! Se não há nada para contar, o número é o 0 (zero).", "tag": "vocabulario-numero" } ],
