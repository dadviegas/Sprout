...
```quiz
{
  ...
  "questions": [
    { "q": "Numa conta armada, os algarismos alinham-se…", "layout": "grid",
      "options": [ { "t": "pela direita", "emoji": "📐", "correct": true }, { "t": "pela esquerda", "feedback": "Alinhar à esquerda baralha as casas. Encostamos à direita para as unidades ficarem debaixo das unidades.", "tag": "conta-armada-alinhar" }, { "t": "pelo meio", "feedback": "Pelo meio os algarismos não ficam na sua casa. Alinha-se sempre pela direita.", "tag": "conta-armada-alinhar" } ],
      "explain": "Unidades debaixo de unidades, dezenas debaixo de dezenas." },
    { "q": "Por que coluna se começa?", "layout": "grid",
      "options": [ { "t": "pelas unidades, à direita", "emoji": "👉", "correct": true }, { "t": "pelas centenas", "feedback": "As centenas são à esquerda. Começa-se pelas unidades, à direita — é de lá que parte o «vai um».", "tag": "conta-armada-alinhar" }, { "t": "tanto faz", "feedback": "A ordem importa por causa do «vai um». Começa-se sempre pelas unidades, à direita.", "tag": "conta-armada-alinhar" } ],
      "explain": "Começa-se sempre pelas unidades — é de lá que parte o «vai um»." },
    { "q": "Na soma, a coluna deu 14. O que fazes?", "layout": "grid",
      "options": [ { "t": "escrevo o 4 e vai 1", "emoji": "➡️", "correct": true }, { "t": "escrevo o 14 todo", "feedback": "Numa coluna só cabe um algarismo. Escreves o 4 e o 1 (dezena) «vai» para a coluna seguinte.", "tag": "conta-armada-transporte" }, { "t": "escrevo o 1 e deito o 4 fora", "feedback": "O 4 são as unidades, não se deita fora! Escreves o 4 e levas o 1 para a coluna ao lado.", "tag": "conta-armada-transporte" } ],
      "explain": "Escreves as unidades (4) e o 1 (uma dezena) vai para a coluna seguinte." },
    { "q": "O «vai um» é, na verdade…", "layout": "grid",
      "options": [ { "t": "10 unidades a virarem 1 dezena", "emoji": "🧊", "correct": true }, { "t": "um número que desaparece", "feedback": "Nada desaparece! São 10 unidades a juntarem-se numa dezena que viaja para a coluna ao lado.", "tag": "conta-armada-transporte" }, { "t": "um erro da conta", "feedback": "Não é erro nenhum — é a regra. 10 unidades viram 1 dezena e «vai um».", "tag": "conta-armada-transporte" } ],
      "explain": "10 cubinhos juntam-se numa barra de dez — por isso viaja para a coluna ao lado." },
    { "q": "Quanto é 357 + 265?", "layout": "grid",
      "options": [ { "t": "622", "correct": true }, { "t": "512", "feedback": "Parece que te esqueceste de transportar. 7+5=12 (vai 1), 5+6+1=12 (vai 1), 3+2+1=6 → 622.", "tag": "conta-armada-transporte" }, { "t": "612", "feedback": "Quase! Falhou um transporte nas dezenas: 5+6+1=12, vai mais 1 → o resultado é 622.", "tag": "conta-armada-transporte" } ],
      "explain": "7+5=12 (vai 1), 5+6+1=12 (vai 1), 3+2+1=6 → 622." },
    { "q": "Na subtração, 2 − 7 não dá. O que fazes?", "layout": "grid",
      "options": [ { "t": "peço 10 emprestado à casa da esquerda", "emoji": "🤝", "correct": true }, { "t": "troco os números de lugar", "feedback": "Na subtração não se trocam os números! Pedes 10 emprestado: 12 − 7 = 5.", "tag": "conta-armada-emprestimo" }, { "t": "escrevo 5 na mesma", "feedback": "Fazer 7 − 2 ao contrário dá 5, mas está errado. Pede 10 emprestado: 12 − 7 = 5.", "tag": "conta-armada-emprestimo" } ],
      "explain": "Pedes 10 emprestado: 12 − 7 = 5 (e o vizinho fica com menos 1)." },
    { "q": "Pedir emprestado é, em blocos…", "layout": "grid",
      "options": [ { "t": "partir 1 dezena em 10 unidades", "emoji": "🔨", "correct": true }, { "t": "juntar 10 unidades numa dezena", "feedback": "Isso é o «vai um» da soma, ao contrário. No empréstimo, parte-se 1 dezena em 10 unidades.", "tag": "conta-armada-emprestimo" }, { "t": "deitar blocos fora", "feedback": "Nenhum bloco se perde! A dezena só se parte em 10 unidades para teres com que tirar.", "tag": "conta-armada-emprestimo" } ],
      "explain": "A barra de dez parte-se em 10 cubinhos para haver unidades que cheguem." },
    { "q": "Quanto é 432 − 187?", "layout": "grid",
      "options": [ { "t": "245", "correct": true }, { "t": "255", "feedback": "Falhou um empréstimo nas dezenas. Com os dois empréstimos: 12−7=5, 12−8=4, 3−1=2 → 245.", "tag": "conta-armada-emprestimo" }, { "t": "345", "feedback": "Esqueceste-te de tirar 1 às centenas depois do empréstimo. O resultado certo é 245.", "tag": "conta-armada-emprestimo" } ],
      "explain": "Dois empréstimos: 12−7=5, 12−8=4, 3−1=2 → 245." },
    { "q": "Como conferes uma subtração?", "layout": "grid",
      "options": [ { "t": "somo o resultado com o que tirei", "emoji": "🕵️", "correct": true }, { "t": "faço a conta outra vez igual", "feedback": "Repetir igual repete o mesmo erro. Confere ao contrário: soma o resultado com o que tiraste.", "tag": "conta-armada-verificar" }, { "t": "não se pode conferir", "feedback": "Pode sim! Soma o resultado com o que tiraste: se der o número de cima, está certa.", "tag": "conta-armada-verificar" } ],
