...
```quiz
{
  ...
  "questions": [
    { "q": "Quantas centenas tem 1 milhar?", "layout": "grid",
      "options": [ { "t": "10", "correct": true }, { "t": "100", "feedback": "100 dezenas há num milhar. Centenas são 10.", "tag": "valor-posicional" }, { "t": "1000", "feedback": "1000 são as unidades. Num milhar há 10 centenas.", "tag": "valor-posicional" } ],
      "explain": "1 milhar = 10 centenas = 1000 unidades." },
    { "q": "No número 4821, o 4 vale…", "layout": "grid",
      "options": [ { "t": "4000", "emoji": "🏔️", "correct": true }, { "t": "400", "feedback": "400 seria o 4 nas centenas. Aqui está nos milhares: 4000.", "tag": "valor-posicional" }, { "t": "4", "feedback": "4 seria nas unidades. Aqui o 4 está nos milhares: 4000.", "tag": "valor-posicional" } ],
      "explain": "O 4 está na gaveta dos milhares: vale 4000." },
    { "q": "A contar de 1000 em 1000, o que vem depois do 6000?", "layout": "grid",
      "options": [ { "t": "7000", "correct": true }, { "t": "6001", "feedback": "Saltas de mil em mil, não de 1 em 1: 6000 → 7000.", "tag": "contagem-numeros" }, { "t": "6100", "feedback": "Esse é salto de 100. De mil em mil: 6000 → 7000.", "tag": "contagem-numeros" } ],
      "explain": "…5000, 6000, 7000 — salto de milhar em milhar!" },
    { "q": "Decompõe o 6543.", "layout": "grid",
      "options": [ { "t": "6000 + 500 + 40 + 3", "correct": true }, { "t": "600 + 50 + 4 + 3", "feedback": "O 6 são milhares (6000) e o 5 centenas (500): 6000 + 500 + 40 + 3.", "tag": "decomposicao" }, { "t": "6000 + 50 + 400 + 3", "feedback": "Troca as gavetas: 5 são centenas (500) e 4 dezenas (40): 6000 + 500 + 40 + 3.", "tag": "decomposicao" } ],
      "explain": "6 milhares + 5 centenas + 4 dezenas + 3 unidades." },
    { "q": "Quanto é 3000 + 200 + 70 + 9?", "layout": "grid",
      "options": [ { "t": "3279", "correct": true }, { "t": "3729", "feedback": "Baralhaste centenas e dezenas: 200 + 70 = 270, fica 3279.", "tag": "decomposicao" }, { "t": "32 709", "feedback": "Não se encostam os números: 3000 + 200 + 70 + 9 = 3279.", "tag": "decomposicao" } ],
      "explain": "Compor: 3000 + 200 + 70 + 9 = 3279." },
    { "q": "Como se lê o número 3500?", "layout": "grid",
      "options": [ { "t": "três mil e quinhentos", "correct": true }, { "t": "trezentos e cinquenta", "feedback": "Isso é 350. 3500 tem 3 milhares: três mil e quinhentos.", "tag": "leitura-numero" }, { "t": "trinta e cinco mil", "feedback": "Isso é 35 000. 3500 é três mil e quinhentos.", "tag": "leitura-numero" } ],
      "explain": "3 milhares e 5 centenas: três mil e quinhentos." },
    { "q": "Qual é o número maior?", "layout": "grid",
      "options": [ { "t": "5230", "correct": true }, { "t": "4980", "feedback": "Compara os milhares: 5 > 4, logo 5230 é maior que 4980.", "tag": "comparar-numeros" }, { "t": "999", "feedback": "999 nem chega aos milhares. 5230 é muito maior.", "tag": "comparar-numeros" } ],
      "explain": "Começa pelos milhares: 5 ganha a 4 (e o 999 nem tem milhares)." },
    { "q": "Arredonda 2463 à centena.", "layout": "grid",
      "options": [ { "t": "2500", "emoji": "🎯", "correct": true }, { "t": "2400", "feedback": "O 63 passa do meio (50): sobe para 2500.", "tag": "arredondar" }, { "t": "2000", "feedback": "Arredondar à centena não vai ao milhar. 2463 → 2500.", "tag": "arredondar" } ],
      "explain": "2463 está entre 2400 e 2500; o 63 passa do meio, sobe para 2500." },
    { "q": "No número 7006, as centenas…", "layout": "grid",
      "options": [ { "t": "estão vazias (0)", "correct": true }, { "t": "têm 7", "feedback": "O 7 está nos milhares. As centenas têm 0 (vazias).", "tag": "gaveta-vazia" }, { "t": "têm 6", "feedback": "O 6 está nas unidades. As centenas têm 0 (vazias).", "tag": "gaveta-vazia" } ],
...
```quiz
{
  ...
  "questions": [
    { "q": "Um milhar é o mesmo que…", "layout": "grid",
      "options": [ { "t": "10 centenas", "emoji": "🏔️", "correct": true }, { "t": "10 dezenas", "feedback": "10 dezenas são só 100 (uma centena). Um milhar são 10 centenas.", "tag": "valor-posicional" }, { "t": "100 milhares", "feedback": "100 milhares é muitíssimo (100 000). Um milhar são 10 centenas.", "tag": "valor-posicional" } ],
      "explain": "10 centenas de 100 fazem 1 milhar = 1000." },
    { "q": "5872 é igual a…", "layout": "grid",
      "options": [ { "t": "5000 + 800 + 70 + 2", "correct": true }, { "t": "500 + 80 + 7 + 2", "feedback": "Cada algarismo na sua gaveta: 5000 + 800 + 70 + 2.", "tag": "decomposicao" }, { "t": "5000 + 80 + 700 + 2", "feedback": "Troca as gavetas: 8 são centenas (800) e 7 dezenas (70).", "tag": "decomposicao" } ],
      "explain": "5 milhares + 8 centenas + 7 dezenas + 2 unidades." },
    { "q": "Quanto vale 2 milhares + 0 centenas + 4 dezenas + 6 unidades?", "layout": "grid",
      "options": [ { "t": "2046", "correct": true }, { "t": "246", "feedback": "Faltou o milhar e o zero das centenas: 2000 + 40 + 6 = 2046.", "tag": "decomposicao" }, { "t": "2460", "feedback": "O 4 são dezenas (40) e o 6 unidades: 2000 + 40 + 6 = 2046.", "tag": "decomposicao" } ],
    ...
    { "q": "A contar de 1000 em 1000, o que vem depois do 9000?", "layout": "grid",
      "options": [ { "t": "10 000", "emoji": "🎉", "correct": true }, { "t": "9001", "feedback": "Saltas de mil em mil: 9000 → 10 000.", "tag": "contagem-numeros" }, { "t": "9100", "feedback": "Esse é salto de 100. De mil em mil: 9000 → 10 000.", "tag": "contagem-numeros" } ],
      "explain": "…8000, 9000, 10 000 — dez mil!" },
    { "q": "Como se lê o número 4821?", "layout": "grid",
      "options": [ { "t": "quatro mil oitocentos e vinte e um", "correct": true }, { "t": "quarenta e oito mil e vinte e um", "feedback": "Isso é 48 021. 4821 é quatro mil oitocentos e vinte e um.", "tag": "leitura-numero" }, { "t": "quatrocentos e oitenta e dois", "feedback": "Isso é 482. 4821 tem 4 milhares: quatro mil oitocentos e vinte e um.", "tag": "leitura-numero" } ],
      "explain": "4 milhares + 821: quatro mil oitocentos e vinte e um." },
    { "q": "Qual o sinal certo: 3642 __ 3675?", "layout": "grid",
      "options": [ { "t": "< (menor que)", "correct": true }, { "t": "> (maior que)", "feedback": "Milhares e centenas empatam. Nas dezenas, 4 < 7: 3642 é MENOR, usa <.", "tag": "comparar-numeros" }, { "t": "= (igual a)", "feedback": "Não são iguais: nas dezenas 4 ≠ 7. 3642 < 3675.", "tag": "comparar-numeros" } ],
      "explain": "Milhares e centenas empatam; nas dezenas, 4 < 7, logo 3642 < 3675." },
    { "q": "Arredonda 7820 à centena.", "layout": "grid",
      "options": [ { "t": "7800", "correct": true }, { "t": "7900", "feedback": "As dezenas (20) não chegam ao meio (50): fica 7800.", "tag": "arredondar" }, { "t": "8000", "feedback": "À centena, não ao milhar. 7820 → 7800.", "tag": "arredondar" } ],
      "explain": "As dezenas (20) não chegam ao meio (50): fica 7800." },
    { "q": "Arredonda 3150 à centena.", "layout": "grid",
      "options": [ { "t": "3200", "emoji": "⬆️", "correct": true }, { "t": "3100", "feedback": "Mesmo a meio (acaba em 50), a regra manda subir: 3200.", "tag": "arredondar" }, { "t": "3000", "feedback": "À centena, não ao milhar. 3150 → 3200.", "tag": "arredondar" } ],
      "explain": "Mesmo a meio (acaba em 50) → a regra manda subir: 3200." },
    { "q": "Coloca por ordem crescente: 4980, 5230, 4899.", "layout": "grid",
      "options": [ { "t": "4899, 4980, 5230 ⬆️", "correct": true }, { "t": "5230, 4980, 4899", "feedback": "Isso é decrescente (do maior). Crescente: 4899, 4980, 5230.", "tag": "ordenar-numeros" }, { "t": "4980, 4899, 5230", "feedback": "O 4899 é o menor, vem primeiro: 4899, 4980, 5230.", "tag": "ordenar-numeros" } ],
