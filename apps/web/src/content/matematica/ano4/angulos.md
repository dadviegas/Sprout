...
```quiz
{
  ...
  "questions": [
    { "q": "Duas retas que nunca se cruzam são...", "layout": "grid",
      "options": [ { "t": "paralelas", "emoji": "🚂", "correct": true }, { "t": "perpendiculares", "emoji": "➕" }, { "t": "concorrentes", "emoji": "✂️" } ],
    ...
    { "q": "O ponto onde o ângulo começa chama-se...", "layout": "grid",
      "options": [ { "t": "vértice", "emoji": "📍", "correct": true }, { "t": "lado" }, { "t": "régua" } ],
    ...
    { "q": "Quantos graus tem um ângulo reto?", "layout": "grid",
      "options": [ { "t": "90°", "correct": true }, { "t": "180°" }, { "t": "10°" } ],
...
```quiz
{
  ...
  "questions": [
    { "q": "Um segmento de reta tem...", "layout": "grid",
      "options": [ { "t": "princípio e fim", "emoji": "📏", "correct": true }, { "t": "nenhum fim" } ],
    ...
    { "q": "Os carris do comboio, que nunca se cruzam, são...", "layout": "grid",
      "options": [ { "t": "paralelas", "emoji": "🚂", "correct": true }, { "t": "perpendiculares", "emoji": "➕" } ],
    ...
    { "q": "As duas semirretas que abrem a boca do ângulo chamam-se...", "layout": "grid",
      "options": [ { "t": "lados", "emoji": "🐊", "correct": true }, { "t": "vértices" }, { "t": "pontos" } ],
