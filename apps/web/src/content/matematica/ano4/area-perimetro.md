...
```quiz
{
  ...
  "questions": [
    { "q": "Perímetro de um quadrado de lado 5 cm?", "layout": "grid",
      "options": [ { "t": "20 cm", "emoji": "🔲", "correct": true }, { "t": "10 cm" }, { "t": "25 cm" } ],
      "explain": "5 + 5 + 5 + 5 = 20 cm (ou 5 × 4)." },
    { "q": "Área de um retângulo 2 cm × 3 cm?", "layout": "grid",
      "options": [ { "t": "6 cm²", "emoji": "🟦", "correct": true }, { "t": "5 cm²" }, { "t": "10 cm²" } ],
      "explain": "2 × 3 = 6 cm²." },
    { "q": "O perímetro mede-se em…", "layout": "grid",
      "options": [ { "t": "cm (comprimento)", "correct": true }, { "t": "cm² (quadradinhos)" }, { "t": "kg" } ],
    ...
    { "q": "Como calculas o perímetro de um retângulo?", "layout": "grid",
      "options": [ { "t": "(comprimento + largura) × 2", "correct": true }, { "t": "comprimento × largura" }, { "t": "comprimento + largura" } ],
    ...
    { "q": "Perímetro de um retângulo de 4 cm por 2 cm?", "layout": "grid",
      "options": [ { "t": "12 cm", "correct": true }, { "t": "8 cm" }, { "t": "6 cm" } ],
      "explain": "4 + 2 + 4 + 2 = 12 cm." },
    { "q": "Área de um quadrado de lado 3 cm?", "layout": "grid",
      "options": [ { "t": "9 cm²", "emoji": "🟦", "correct": true }, { "t": "12 cm²" }, { "t": "6 cm²" } ],
      "explain": "3 × 3 = 9 cm²." },
    ...
    { "q": "Um triângulo tem lados de 3 cm, 4 cm e 5 cm. Perímetro?", "layout": "grid",
      "options": [ { "t": "12 cm", "emoji": "🔺", "correct": true }, { "t": "60 cm" }, { "t": "9 cm" } ],
      "explain": "3 + 4 + 5 = 12 cm." }
  ]
}
```
...
```quiz
{
  ...
  "questions": [
    { "q": "O perímetro é…", "layout": "grid",
      "options": [ { "t": "a soma de todos os lados", "emoji": "🔲", "correct": true }, { "t": "o espaço de dentro" }, { "t": "o peso da figura" } ],
      "explain": "Perímetro = soma de todos os lados (a volta)." },
    { "q": "A área mede-se em…", "layout": "grid",
      "options": [ { "t": "cm²", "emoji": "🟦", "correct": true }, { "t": "cm" }, { "t": "kg" } ],
    ...
    { "q": "Perímetro de um quadrado de lado 6 cm?", "layout": "grid",
      "options": [ { "t": "24 cm", "correct": true }, { "t": "36 cm" }, { "t": "12 cm" } ],
    ...
    { "q": "Qual destas é a unidade da ÁREA?", "layout": "grid",
      "options": [ { "t": "m² (metro quadrado)", "correct": true }, { "t": "m (metro)" }, { "t": "litro" } ],
      "explain": "A área usa unidades quadradas: cm², m²." },
    { "q": "Duas figuras com o mesmo perímetro têm sempre a mesma área?", "layout": "grid",
      "options": [ { "t": "Não, podem ter áreas diferentes", "emoji": "🤯", "correct": true }, { "t": "Sim, é sempre igual" } ],
