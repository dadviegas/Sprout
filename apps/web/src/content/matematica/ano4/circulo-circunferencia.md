...
```quiz
{
  ...
  "questions": [
    { "q": "A borda da pizza é a ________; a pizza toda é o ________.", "layout": "list",
      "options": [ { "t": "circunferência … círculo", "emoji": "🍕", "correct": true }, { "t": "círculo … circunferência" } ],
    ...
    { "q": "Uma linha de borda a borda que NÃO passa pelo centro…", "layout": "list",
      "options": [ { "t": "não é um diâmetro", "emoji": "🪢", "correct": true }, { "t": "é um diâmetro na mesma" }, { "t": "é um raio" } ],
    ...
    { "q": "Qual é o instrumento que desenha circunferências perfeitas?", "layout": "grid",
      "options": [ { "t": "o compasso", "emoji": "🧭", "correct": true }, { "t": "a régua", "emoji": "📏" }, { "t": "a borracha" } ],
