...
```quiz
{
  ...
  "questions": [
    { "q": "Em 156 : 4, o 4 chama-se…", "layout": "grid",
      "options": [ { "t": "divisor", "emoji": "➗", "correct": true }, { "t": "quociente", "feedback": "O quociente é o resultado da divisão (o que calha a cada um), não o número por quem divides. O 4 é o divisor — é por quanto repartes.", "tag": "div-vocabulario" }, { "t": "resto", "feedback": "O resto é o que sobra no fim. O 4 está antes de fazeres a conta — é o divisor, o número por quem divides.", "tag": "div-vocabulario" } ],
      "explain": "O divisor é por quanto divides — escreve-se à direita da barra." },
    { "q": "A dança da divisão é…", "layout": "grid",
      "options": [ { "t": "cabe → multiplica → tira → baixa", "emoji": "💃", "correct": true }, { "t": "soma → tira → baixa", "feedback": "Na divisão não há somar no meio da dança. A ordem certa é: vês quantas vezes cabe, multiplicas, tiras e baixas o algarismo seguinte.", "tag": "div-calculo" }, { "t": "multiplica → soma → sobe", "feedback": "Não se soma nem se sobe nada. A dança é cabe → multiplica → tira → baixa o algarismo, sempre de cima para baixo.", "tag": "div-calculo" } ],
      "explain": "Quantas vezes cabe, multiplicas, subtrais e baixas o algarismo seguinte." },
    { "q": "Quanto é 156 : 4?", "layout": "grid",
      "options": [ { "t": "39", "emoji": "🎉", "correct": true }, { "t": "36", "feedback": "36 fica a meio: 15:4 dá 3 e depois falta baixar o 6 e dividir o 36. A conta toda dá 39.", "tag": "div-calculo" }, { "t": "41", "feedback": "41 é demais: 41 × 4 = 164, maior que 156. O certo é 39, porque 39 × 4 = 156.", "tag": "div-calculo" } ],
      "explain": "15:4 dá 3 (sobra 3); baixa o 6 → 36:4 = 9 → 39." },
    { "q": "175 : 4 dá 43 e resto 3. O resto quer dizer que…", "layout": "grid",
      "options": [ { "t": "sobram 3 que já não dá para repartir", "emoji": "🤏", "correct": true }, { "t": "a conta está errada", "feedback": "Não! Um resto é normal — nem tudo se reparte certinho. O resto 3 só quer dizer que sobraram 3 que já não chegam para dar 1 a cada um.", "tag": "div-resto" }, { "t": "cada um recebe mais 3", "feedback": "Cada um recebe só 43. Os 3 do resto são o que SOBRA depois de repartir, não algo a mais para cada um.", "tag": "div-resto" } ],
    ...
    { "q": "Dividiste por 6 e o resto deu 7. O que aconteceu?", "layout": "grid",
      "options": [ { "t": "a conta está mal — o 6 ainda cabia mais uma vez", "emoji": "🚨", "correct": true }, { "t": "está tudo bem", "feedback": "Não está bem: o resto tem de ser SEMPRE menor que o divisor. Como 7 é maior que 6, o 6 ainda cabia mais uma vez.", "tag": "div-resto" }, { "t": "o resto pode ser qualquer número", "feedback": "O resto não pode ser qualquer número: tem de ser sempre menor que o divisor. Por 6, o resto só pode ir de 0 a 5.", "tag": "div-resto" } ],
      "explain": "O resto tem de ser SEMPRE menor que o divisor." },
    { "q": "Quanto é 260 : 12?", "layout": "grid",
      "options": [ { "t": "21, resto 8", "emoji": "🏆", "correct": true }, { "t": "22, resto 0", "feedback": "22 é demais: 22 × 12 = 264, maior que 260. O certo é 21 com resto 8 (21 × 12 + 8 = 260).", "tag": "div-calculo" }, { "t": "20, resto 20", "feedback": "O resto 20 não pode ser, porque tem de ser menor que 12! Faltou dividir mais uma vez: o certo é 21, resto 8.", "tag": "div-resto" } ],
...
```quiz
{
  ...
  "questions": [
    { "q": "Dividir 12 : 3 é…", "layout": "grid",
      "options": [ { "t": "repartir 12 em 3 partes iguais", "emoji": "🍪", "correct": true }, { "t": "tirar 3 a 12", "feedback": "Tirar 3 a 12 é uma subtração (12 − 3 = 9), não uma divisão. Dividir 12 : 3 é repartir 12 em 3 partes iguais, e dá 4.", "tag": "div-vs-mult" }, { "t": "juntar 12 com 3", "feedback": "Juntar é somar (12 + 3 = 15). Dividir 12 : 3 é repartir os 12 por 3, e cada parte fica com 4.", "tag": "div-vs-mult" } ],
      "explain": "Cada parte fica com 4 — é a pergunta «quantas vezes cabe?»." },
    { "q": "Numa conta de dividir, o divisor escreve-se…", "layout": "grid",
      "options": [ { "t": "à direita da barra", "emoji": "➗", "correct": true }, { "t": "por baixo do dividendo", "feedback": "Por baixo do divisor é onde aparece o quociente (a resposta). O divisor escreve-se à direita da barra.", "tag": "div-vocabulario" }, { "t": "onde houver espaço", "feedback": "Cada número tem o seu lugar certinho: dividendo à esquerda, divisor à direita da barra. Não é ao calhas.", "tag": "div-vocabulario" } ],
    ...
    { "q": "Depois de subtrair, o passo seguinte é…", "layout": "grid",
      "options": [ { "t": "baixar o algarismo seguinte", "emoji": "⬇️", "correct": true }, { "t": "subir um algarismo", "feedback": "Na divisão nunca se sobe — a regra de ouro é BAIXAR o algarismo seguinte do dividendo para junto do que sobrou.", "tag": "div-calculo" }, { "t": "acabar a conta", "feedback": "Ainda não acaba! Enquanto houver algarismos por baixar, baixas o seguinte e a dança recomeça. Só acaba quando não há mais que baixar.", "tag": "div-calculo" } ],
      "explain": "Baixa-se o próximo algarismo do dividendo e a dança recomeça." },
    { "q": "Quanto é 156 : 4?", "layout": "grid",
      "options": [ { "t": "39", "correct": true }, { "t": "38", "feedback": "38 fica perto, mas é pouco: 38 × 4 = 152, e faltam 4. O certo é 39, porque 39 × 4 = 156 certinho.", "tag": "div-calculo" }, { "t": "44", "feedback": "44 é demais: 44 × 4 = 176, bem maior que 156. O certo é 39.", "tag": "div-calculo" } ],
      "explain": "15:4=3 (sobra 3), baixa o 6, 36:4=9 → 39." },
    { "q": "Quanto é 175 : 4?", "layout": "grid",
      "options": [ { "t": "43, resto 3", "emoji": "🤏", "correct": true }, { "t": "43, resto 0", "feedback": "O quociente 43 está certo, mas o resto não é 0: 43 × 4 = 172, e 175 − 172 = 3. Sobram 3.", "tag": "div-resto" }, { "t": "44, resto 1", "feedback": "44 é demais: 44 × 4 = 176, que já passa de 175. O certo é 43 com resto 3.", "tag": "div-calculo" } ],
      "explain": "17:4=4 (sobra 1), baixa o 5, 15:4=3, resto 3." },
    { "q": "O resto de uma divisão por 12 pode ser…", "layout": "grid",
      "options": [ { "t": "qualquer número de 0 a 11", "emoji": "✅", "correct": true }, { "t": "12", "feedback": "12 não pode: o resto tem de ser MENOR que o divisor. Se o resto desse 12, o 12 ainda cabia mais uma vez. Vai só de 0 a 11.", "tag": "div-resto" }, { "t": "qualquer número", "feedback": "Não pode ser qualquer número — tem de ser menor que o divisor. Ao dividir por 12, o resto só pode ir de 0 a 11.", "tag": "div-resto" } ],
      "explain": "O resto é sempre MENOR que o divisor — senão ainda cabia mais uma vez." },
    { "q": "Quanto é 260 : 12?", "layout": "grid",
      "options": [ { "t": "21, resto 8", "correct": true }, { "t": "12, resto 2", "feedback": "12 é o divisor, não a resposta! O quociente de 260 : 12 é 21, com resto 8 (21 × 12 + 8 = 260).", "tag": "div-calculo" }, { "t": "26, resto 0", "feedback": "26 é demais: 26 × 12 = 312, muito maior que 260. O certo é 21 com resto 8.", "tag": "div-calculo" } ],
      "explain": "2×12=24, 26−24=2; baixa o 0 → 20; 1×12=12, 20−12=8 → 21 r 8." },
    { "q": "Como conferes que 260 : 12 = 21 com resto 8?", "layout": "grid",
      "options": [ { "t": "21 × 12 + 8 = 260 ✓", "emoji": "🕵️", "correct": true }, { "t": "21 + 12 + 8", "feedback": "Para conferir não se soma tudo: a divisão confere-se ao contrário, multiplicando. Faz quociente × divisor + resto: 21 × 12 + 8 = 260.", "tag": "conta-armada-verificar" }, { "t": "260 × 12", "feedback": "Multiplicar o dividendo pelo divisor não confere nada. A prova certa é quociente × divisor + resto: 21 × 12 + 8 = 260.", "tag": "conta-armada-verificar" } ],
