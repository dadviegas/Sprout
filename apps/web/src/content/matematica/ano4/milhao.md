...
```quiz
{
  ...
  "questions": [
    { "q": "Como se lê o número 1 000 000?", "layout": "grid",
      "options": [ { "t": "um milhão", "emoji": "🎉", "correct": true }, { "t": "mil", "feedback": "Mil é 1 000 (3 zeros). 1 000 000 tem 6 zeros: um milhão.", "tag": "leitura-numero" }, { "t": "cem mil", "feedback": "Cem mil é 100 000 (5 zeros). Com 6 zeros é um milhão.", "tag": "leitura-numero" } ],
      "explain": "1 000 000 lê-se 'um milhão' — tem 6 zeros." },
    { "q": "Quantas unidades tem 1 milhar?", "layout": "grid",
      "options": [ { "t": "1 000", "correct": true }, { "t": "100", "feedback": "100 é uma centena. 1 milhar é dez vezes maior: 1 000.", "tag": "valor-posicional" }, { "t": "10", "feedback": "10 é uma dezena. 1 milhar vale 1 000 unidades.", "tag": "valor-posicional" } ],
      "explain": "1 milhar = 1 000 unidades (mil)." },
    { "q": "No número 487 600, quanto vale o algarismo 8?", "layout": "grid",
      "options": [ { "t": "80 000", "correct": true }, { "t": "8 000", "feedback": "8 000 seria o 8 nas unidades de milhar. Aqui está nas dezenas de milhar: 80 000.", "tag": "valor-posicional" }, { "t": "800", "feedback": "800 é o 8 nas centenas. Mas está nas dezenas de milhar: vale 80 000.", "tag": "valor-posicional" } ],
      "explain": "O 8 está nas dezenas de milhar: vale 80 000." },
    { "q": "Qual destes números é o MAIOR?", "layout": "grid",
      "options": [ { "t": "320 000", "correct": true }, { "t": "98 000", "feedback": "98 000 tem 5 algarismos; 320 000 tem 6. Quem tem mais algarismos é maior.", "tag": "comparar-numeros" }, { "t": "65 400", "feedback": "65 400 tem 5 algarismos; 320 000 tem 6, logo é maior.", "tag": "comparar-numeros" } ],
    ...
    { "q": "Separamos os algarismos em grupos de quantos?", "layout": "grid",
      "options": [ { "t": "3", "emoji": "3️⃣", "correct": true }, { "t": "2", "feedback": "Os algarismos agrupam-se de 3 em 3, da direita para a esquerda: 245 800.", "tag": "leitura-numero" }, { "t": "5", "feedback": "Não é de 5. Agrupam-se de 3 em 3: 245 800.", "tag": "leitura-numero" } ],
      "explain": "Em grupos de 3, da direita para a esquerda: 245 800." },
    { "q": "Que sinal completa: 845 000 ___ 839 000?", "layout": "grid",
      "options": [ { "t": ">", "correct": true }, { "t": "<", "feedback": "< quer dizer menor, mas 845 000 é maior que 839 000 (4 > 3 nas dezenas de milhar). O certo é >.", "tag": "comparar-numeros" }, { "t": "=", "feedback": "Não são iguais: na 1.ª ordem diferente 4 > 3, logo 845 000 > 839 000.", "tag": "comparar-numeros" } ],
      "explain": "Na 1.ª ordem diferente, 4 > 3, logo 845 000 é maior." },
    { "q": "No número 600 000, em que ordem está o 6?", "layout": "grid",
      "options": [ { "t": "centenas de milhar", "correct": true }, { "t": "dezenas de milhar", "feedback": "Nas dezenas de milhar o 6 valeria 60 000. Aqui vale 600 000: centenas de milhar.", "tag": "valor-posicional" }, { "t": "unidades de milhar", "feedback": "Aí valeria 6 000. O 6 vale 600 000: está nas centenas de milhar.", "tag": "valor-posicional" } ],
      "explain": "O 6 vale 600 000 — está nas centenas de milhar." },
    { "q": "Que número vem logo a seguir a 999 999?", "layout": "grid",
      "options": [ { "t": "1 000 000", "emoji": "🚀", "correct": true }, { "t": "100 000", "feedback": "100 000 é bem menor que 999 999. A seguir vem 1 000 000 (mais um).", "tag": "contagem-numeros" }, { "t": "999 990", "feedback": "999 990 vem antes. A seguir a 999 999 é 1 000 000.", "tag": "contagem-numeros" } ],
      "explain": "999 999 + 1 = 1 000 000, ou seja, um milhão!" },
    { "q": "Quanto vale 'quatrocentos e sete mil e sessenta' em algarismos?", "layout": "grid",
      "options": [ { "t": "407 060", "correct": true }, { "t": "47 060", "feedback": "47 060 é quarenta e sete mil. Quatrocentos e sete mil é 407 000, mais 60 → 407 060.", "tag": "leitura-numero" }, { "t": "470 060", "feedback": "470 060 é quatrocentos e setenta mil. Quatrocentos e SETE mil é 407 000 → 407 060.", "tag": "leitura-numero" } ],
