...
```quiz
{
  ...
  "questions": [
    { "q": "50% é o mesmo que…", "layout": "grid",
      "options": [ { "t": "a metade", "emoji": "✌️", "correct": true }, { "t": "a quarta parte", "feedback": "A quarta parte é 25%, não 50%. 50% é a metade — divide por 2.", "tag": "percent-fracao" }, { "t": "o todo", "feedback": "O todo é 100%. 50% é só metade do todo.", "tag": "percent-do-todo" } ],
      "explain": "50 em cada 100 = 1/2 — divide por 2." },
    { "q": "Quanto é 50% de 18?", "layout": "grid",
      "options": [ { "t": "9", "correct": true }, { "t": "8", "feedback": "8 não é a metade de 18. Metade de 18 é 18 ÷ 2 = 9.", "tag": "percent-do-todo" }, { "t": "36", "feedback": "36 é o dobro de 18, não a metade. 50% é metade: 18 ÷ 2 = 9.", "tag": "percent-do-todo" } ],
      "explain": "50% = metade: 18 ÷ 2 = 9." },
    { "q": "Quanto é 25% de 40?", "layout": "grid",
      "options": [ { "t": "10", "correct": true }, { "t": "20", "feedback": "20 é metade (50%) de 40. 25% é a quarta parte: 40 ÷ 4 = 10.", "tag": "percent-fracao" }, { "t": "4", "feedback": "Dividiste por 10 (isso é 10%). 25% divide por 4: 40 ÷ 4 = 10.", "tag": "percent-fracao" } ],
      "explain": "25% = quarta parte: 40 ÷ 4 = 10." },
    { "q": "Quanto é 10% de 50?", "layout": "grid",
      "options": [ { "t": "5", "emoji": "🔟", "correct": true }, { "t": "10", "feedback": "10 é o 10% que está no nome, não o resultado. 10% de 50 é 50 ÷ 10 = 5.", "tag": "percent-do-todo" }, { "t": "25", "feedback": "25 é metade (50%) de 50. 10% divide por 10: 50 ÷ 10 = 5.", "tag": "percent-fracao" } ],
      "explain": "10% = dividir por 10: 50 ÷ 10 = 5." },
    { "q": "A bateria do tablet está a 100%. Isso quer dizer…", "layout": "grid",
      "options": [ { "t": "está toda carregada", "emoji": "🔋", "correct": true }, { "t": "está a meio", "feedback": "A meio seria 50%. 100% é o todo — carga completa.", "tag": "percent-do-todo" }, { "t": "está vazia", "feedback": "Vazia seria 0%. 100% é tudo — a bateria cheia.", "tag": "percent-do-todo" } ],
      "explain": "100% é o todo — carga completa." },
    { "q": "Num orçamento, o dinheiro que ENTRA chama-se…", "layout": "grid",
      "options": [ { "t": "receitas", "emoji": "📥", "correct": true }, { "t": "despesas", "emoji": "📤", "feedback": "Despesas é o dinheiro que SAI. O que entra são as «receitas».", "tag": "orcamento-termos" }, { "t": "saldo", "feedback": "O saldo é o que SOBRA no fim. O que entra são as «receitas».", "tag": "orcamento-termos" } ],
    ...
    { "q": "Recebes 10 € e gastas 7 €. Qual é o teu saldo?", "emoji": "💰", "layout": "grid",
      "options": [ { "t": "3 €", "correct": true }, { "t": "7 €", "feedback": "7 € foi o que gastaste, não o que sobrou. Saldo = 10 − 7 = 3 €.", "tag": "orcamento-saldo" }, { "t": "17 €", "feedback": "Somaste em vez de tirar. O saldo tira a despesa: 10 − 7 = 3 €.", "tag": "problema-operacao-errada" } ],
      "explain": "Saldo = receitas − despesas: 10 − 7 = 3 €." },
    { "q": "Comeste 75% da pizza. Quantas fatias de 4 comeste?", "layout": "grid",
      "options": [ { "t": "3", "emoji": "🍕", "correct": true }, { "t": "1", "feedback": "1 fatia de 4 é 25%. 75% são três fatias de quatro (3/4).", "tag": "percent-fracao" }, { "t": "4", "feedback": "4 fatias seriam a pizza toda (100%). 75% são 3 de 4.", "tag": "percent-fracao" } ],
      "explain": "75% = 3/4: três fatias de quatro." },
    { "q": "Um livro de 20 € tem 10% de desconto. Quanto poupas?", "layout": "grid",
      "options": [ { "t": "2 €", "correct": true }, { "t": "10 €", "feedback": "10 é o número do «10%», não o desconto. 10% de 20 € = 20 ÷ 10 = 2 €.", "tag": "percent-do-todo" }, { "t": "18 €", "feedback": "18 € é o que pagas depois do desconto, não o que poupas. Poupas 20 ÷ 10 = 2 €.", "tag": "problema-passo-em-falta" } ],
