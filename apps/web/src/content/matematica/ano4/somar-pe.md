...
```quiz
{
  ...
  "questions": [
    { "q": "Na soma em pé, os números inteiros alinham-se…", "layout": "grid",
      "options": [ { "t": "pela direita", "emoji": "📐", "correct": true }, { "t": "pela esquerda", "feedback": "Alinhar à esquerda baralha as casas. Na conta em pé alinhas pela direita: unidades debaixo de unidades.", "tag": "conta-armada-alinhar" }, { "t": "pelo meio", "feedback": "Não há «meio» numa conta em pé. Alinhas pela direita: unidades com unidades, dezenas com dezenas.", "tag": "conta-armada-alinhar" } ],
      "explain": "Unidades debaixo de unidades, dezenas debaixo de dezenas." },
    { "q": "A coluna das unidades deu 15. O que escreves?", "layout": "grid",
      "options": [ { "t": "escrevo o 5 e vai 1", "emoji": "➡️", "correct": true }, { "t": "escrevo o 15 todo", "feedback": "Em cada coluna só cabe um algarismo. Escreves o 5 e o 1 transporta-se para a coluna seguinte.", "tag": "conta-armada-transporte" }, { "t": "escrevo o 1 e deito o 5 fora", "feedback": "Não se deita nada fora! Escreves as unidades (5) e levas o 1 (a dezena) para a coluna ao lado.", "tag": "conta-armada-transporte" } ],
      "explain": "Escreves as unidades (5) e o 1 viaja para a coluna seguinte." },
    { "q": "Quanto é 247 + 138?", "layout": "grid",
      "options": [ { "t": "385", "emoji": "🎉", "correct": true }, { "t": "375", "feedback": "Esqueceste o «vai 1»: 7+8=15, escreves 5 e somas 1 às dezenas: 4+3+1=8 → 385.", "tag": "conta-armada-transporte" }, { "t": "395", "feedback": "Somaste o transporte a mais. 7+8=15 (vai 1), 4+3+1=8, 2+1=3 → 385.", "tag": "conta-armada-transporte" } ],
      "explain": "7+8=15 (vai 1), 4+3+1=8, 2+1=3 → 385." },
    { "q": "Para somar 12,5 + 3,75, alinhas…", "layout": "grid",
      "options": [ { "t": "as vírgulas, uma debaixo da outra", "emoji": "📐", "correct": true }, { "t": "tudo à direita, como inteiros", "feedback": "Com decimais não alinhas pelo fim: pões a vírgula debaixo da vírgula (12,50 + 3,75).", "tag": "decimal-conta-alinhamento" }, { "t": "tudo à esquerda", "feedback": "Alinhar à esquerda mistura as casas. Pões a vírgula debaixo da vírgula.", "tag": "decimal-conta-alinhamento" } ],
      "explain": "Vírgula debaixo de vírgula — e 12,5 pode virar 12,50 para ajudar." },
    { "q": "Quanto é 478 + 256?", "layout": "grid",
      "options": [ { "t": "734", "emoji": "🔥", "correct": true }, { "t": "624", "feedback": "Parece que esqueceste os transportes. 8+6=14 (vai 1), 7+5+1=13 (vai 1), 4+2+1=7 → 734.", "tag": "conta-armada-transporte" }, { "t": "724", "feedback": "Falhou um transporte no meio: 7+5+1=13 (vai 1), e 4+2+1=7 → 734.", "tag": "conta-armada-transporte" } ],
      "explain": "8+6=14 (vai 1), 7+5+1=13 (vai 1), 4+2+1=7 → 734." },
    { "q": "Numa soma de 3 parcelas, a coluna deu 17. O que fazes?", "layout": "grid",
      "options": [ { "t": "escrevo o 7 e vai 1", "emoji": "➡️", "correct": true }, { "t": "escrevo o 17 todo", "feedback": "Mesmo com 3 parcelas, só escreves um algarismo por coluna: o 7, e vai 1.", "tag": "conta-armada-transporte" }, { "t": "não se pode somar 3 números", "feedback": "Pode-se, sim! Somas a coluna toda (deu 17), escreves o 7 e transportas o 1.", "tag": "conta-armada-alinhar" } ],
...
```quiz
{
  ...
  "questions": [
    { "q": "Por que coluna começas a somar?", "layout": "grid",
      "options": [ { "t": "pelas unidades, à direita", "emoji": "👉", "correct": true }, { "t": "pelas centenas", "feedback": "Se começasses pelas centenas, o «vai 1» não teria para onde ir. Começa-se à direita, pelas unidades.", "tag": "conta-armada-alinhar" }, { "t": "por qualquer uma", "feedback": "A ordem importa: começa sempre à direita, pelas unidades, por causa do transporte.", "tag": "conta-armada-alinhar" } ],
      "explain": "Começa-se sempre à direita — é de lá que parte o «vai 1»." },
    { "q": "Quanto é 321 + 456?", "layout": "grid",
      "options": [ { "t": "777", "emoji": "🎰", "correct": true }, { "t": "767", "feedback": "Confere a coluna do meio: 2+5=7, não 6. A soma é 777.", "tag": "soma-calculo" }, { "t": "787", "feedback": "Confere a coluna do meio: 2+5=7, não 8. Sem transportes, a soma é 777.", "tag": "soma-calculo" } ],
      "explain": "1+6=7, 2+5=7, 3+4=7 → 777, sem nenhum transporte." },
    { "q": "O «vai 1» é, na verdade…", "layout": "grid",
      "options": [ { "t": "10 unidades a virarem 1 dezena", "emoji": "🧊", "correct": true }, { "t": "um número que desaparece", "feedback": "Não desaparece! São 10 unidades que se juntam e viram 1 dezena, que viaja para a coluna ao lado.", "tag": "conta-armada-transporte" }, { "t": "um enfeite da conta", "feedback": "O «vai 1» é essencial: 10 de uma casa viram 1 da casa seguinte. Sem ele, a conta fica errada.", "tag": "conta-armada-transporte" } ],
      "explain": "Dez de uma casa juntam-se e mudam-se para a casa ao lado." },
    { "q": "Quanto é 478 + 256?", "layout": "grid",
      "options": [ { "t": "734", "correct": true }, { "t": "722", "feedback": "Falharam transportes: 8+6=14 (vai 1), 7+5+1=13 (vai 1), 4+2+1=7 → 734.", "tag": "conta-armada-transporte" }, { "t": "834", "feedback": "Transportaste a mais para as centenas. 4+2+1=7, não 8 → 734.", "tag": "conta-armada-transporte" } ],
      "explain": "Dois transportes seguidos: 14, depois 13, depois 7 → 734." },
    { "q": "Quanto é 12,5 + 3,75?", "layout": "grid",
      "options": [ { "t": "16,25", "emoji": "🎯", "correct": true }, { "t": "15,80", "feedback": "Parece que somaste mal as casas. Alinha 12,50 + 3,75: dá 16,25.", "tag": "decimal-conta-alinhamento" }, { "t": "13,00", "feedback": "Esse valor é pequeno demais. 12,50 + 3,75 = 16,25.", "tag": "decimal-conta-alinhamento" } ],
      "explain": "12,50 + 3,75: 0+5=5, 5+7=12 (vai 1), 2+3+1=6 → 16,25." },
    { "q": "O erro mais perigoso ao somar decimais é…", "layout": "grid",
      "options": [ { "t": "desalinhar as vírgulas", "emoji": "⚠️", "correct": true }, { "t": "acrescentar um zero a 12,5", "feedback": "Acrescentar o zero (12,50) até ajuda a alinhar — não é erro. O perigo é desalinhar as vírgulas.", "tag": "decimal-conta-alinhamento" }, { "t": "começar pelas centésimas", "feedback": "Começar pela direita (centésimas) está certo. O erro perigoso é desalinhar as vírgulas.", "tag": "decimal-conta-alinhamento" } ],
      "explain": "Sem as vírgulas alinhadas, somas décimas com centésimas — tudo errado!" },
    { "q": "Quanto é 125 + 234 + 148?", "layout": "grid",
      "options": [ { "t": "507", "emoji": "🏆", "correct": true }, { "t": "497", "feedback": "Esqueceste um transporte: 5+4+8=17 (vai 1), 2+3+4+1=10 (vai 1), 1+2+1+1=5 → 507.", "tag": "conta-armada-transporte" }, { "t": "517", "feedback": "Transporte a mais. A soma certa é 507.", "tag": "conta-armada-transporte" } ],
      "explain": "5+4+8=17 (vai 1), 2+3+4+1=10 (vai 1), 1+2+1+1=5 → 507." },
    { "q": "12,5 é o mesmo que…", "layout": "grid",
      "options": [ { "t": "12,50", "emoji": "🪄", "correct": true }, { "t": "12,05", "feedback": "12,05 tem o 5 nas centésimas. Em 12,5 o 5 está nas décimas: 12,5 = 12,50.", "tag": "decimal-decimas-centesimas" }, { "t": "1,25", "feedback": "1,25 mudou a vírgula de sítio. 12,5 = 12,50; o zero à direita não muda o valor.", "tag": "decimal-lados-virgula" } ],
