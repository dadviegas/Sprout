...
```quiz
{
  ...
  "questions": [
    ...
    { "q": "A moda é…", "layout": "grid",
      "options": [ { "t": "o valor mais frequente", "emoji": "🌟", "correct": true }, { "t": "o mais bonito" }, { "t": "a soma de tudo" } ],
...
```quiz
{
  ...
  "questions": [
    ...
    { "q": "A média de 3, 5, 4, 6, 2 é…", "layout": "grid",
      "options": [ { "t": "4", "emoji": "⚖️", "correct": true }, { "t": "5" }, { "t": "20" } ],
      "explain": "Soma 20, divide por 5 valores = 4." },
    { "q": "A moda é o valor que…", "layout": "grid",
      "options": [ { "t": "aparece mais vezes", "emoji": "🌟", "correct": true }, { "t": "está no meio" }, { "t": "é o maior" } ],
      "explain": "Moda = o mais frequente." },
    { "q": "A amplitude calcula-se…", "layout": "grid",
      "options": [ { "t": "máximo − mínimo", "emoji": "📏", "correct": true }, { "t": "somar tudo" }, { "t": "máximo + mínimo" } ],
    ...
    { "q": "Numa linha, quando o valor desce, a linha…", "layout": "grid",
      "options": [ { "t": "desce também", "emoji": "📉", "correct": true }, { "t": "fica plana" }, { "t": "sobe" } ],
    ...
    { "q": "A Mariana leu 3, 5, 4, 6 e 2 páginas. A média diária foi…", "layout": "grid",
      "options": [ { "t": "4 páginas", "emoji": "📚", "correct": true }, { "t": "20 páginas" }, { "t": "6 páginas" } ],
      "explain": "20 páginas ÷ 5 dias = 4 páginas por dia." },
    { "q": "Pôr os números por ordem e escolher o do meio dá a…", "layout": "grid",
      "options": [ { "t": "mediana", "emoji": "🤓", "correct": true }, { "t": "moda" }, { "t": "amplitude" } ],
