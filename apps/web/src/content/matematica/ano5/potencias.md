...
```quiz
{
  ...
  "questions": [
    { "q": "Quanto é 10²?", "layout": "grid",
      "options": [ { "t": "100", "emoji": "💯", "correct": true }, { "t": "20", "feedback": "20 seria 10 × 2. O expoente diz para multiplicar 10 por si próprio: 10 × 10 = 100.", "tag": "potencia-vs-multiplicacao" }, { "t": "1000", "feedback": "1000 é 10³ (3 zeros). 10² tem 2 zeros: 100.", "tag": "potencia-calculo" } ],
      "explain": "10² = 10 × 10 = 100 (2 zeros)." },
    { "q": "Em 10³, o 3 chama-se…", "layout": "grid",
      "options": [ { "t": "expoente", "emoji": "⬆️", "correct": true }, { "t": "base", "feedback": "A base é o número que se repete — aqui o 10. O 3 pequenino em cima é o expoente.", "tag": "potencia-base-expoente" }, { "t": "produto", "feedback": "Produto é o resultado de uma multiplicação. O 3 é o expoente (diz quantas vezes repetes a base).", "tag": "potencia-base-expoente" } ],
      "explain": "O número pequenino em cima é o expoente; o 10 é a base." },
    { "q": "Quanto é 10⁶?", "layout": "grid",
      "options": [ { "t": "1 000 000", "emoji": "😲", "correct": true }, { "t": "60", "feedback": "60 seria 10 × 6. O expoente conta zeros: 10⁶ tem 6 zeros = um milhão.", "tag": "potencia-vs-multiplicacao" }, { "t": "100 000", "feedback": "100 000 tem só 5 zeros (é 10⁵). 10⁶ tem 6 zeros: 1 000 000.", "tag": "potencia-calculo" } ],
      "explain": "Expoente 6 = 6 zeros = um milhão." },
    { "q": "10³ é igual a…", "layout": "grid",
      "options": [ { "t": "10 × 10 × 10", "emoji": "✖️", "correct": true }, { "t": "10 × 3", "feedback": "O expoente não multiplica a base por 3. Diz quantas vezes repetes o 10: 10 × 10 × 10.", "tag": "potencia-vs-multiplicacao" }, { "t": "10 + 10 + 10", "feedback": "Potência é multiplicação repetida, não soma. 10³ = 10 × 10 × 10.", "tag": "potencia-vs-multiplicacao" } ],
      "explain": "O expoente diz quantas vezes multiplicar a base por si própria." },
    { "q": "Quantos zeros tem 10⁵?", "layout": "grid",
      "options": [ { "t": "5", "emoji": "🪄", "correct": true }, { "t": "4", "feedback": "Nas potências de 10 o expoente é igual ao número de zeros: 10⁵ tem 5.", "tag": "potencia-calculo" }, { "t": "6", "feedback": "6 zeros seria 10⁶. O expoente de 10⁵ é 5, logo 5 zeros: 100 000.", "tag": "potencia-calculo" } ],
      "explain": "Nas potências de 10, o expoente conta os zeros: 100 000." },
    { "q": "Quanto é 10⁰?", "layout": "grid",
      "options": [ { "t": "1", "emoji": "🥚", "correct": true }, { "t": "0", "feedback": "Cuidado: 10⁰ não dá 0! Qualquer base elevada a 0 dá 1.", "tag": "potencia-casos-especiais" }, { "t": "10", "feedback": "10 é 10¹ (elevado a 1). Elevado a 0, qualquer número dá 1.", "tag": "potencia-casos-especiais" } ],
      "explain": "Qualquer número elevado a 0 dá 1." },
    { "q": "Quanto é 7 × 10²?", "layout": "grid",
      "options": [ { "t": "700", "emoji": "🚀", "correct": true }, { "t": "72", "feedback": "72 seria 7 × 10 + 2. Aqui × 10² = × 100: 7 × 100 = 700.", "tag": "potencia-multiplicar" }, { "t": "70", "feedback": "70 é 7 × 10 (só 1 zero). 10² é 100, com 2 zeros: 7 × 100 = 700.", "tag": "potencia-multiplicar" } ],
      "explain": "× 10² = × 100: acrescenta 2 zeros → 700." },
    { "q": "Como escreves 5000 com uma potência de 10?", "layout": "grid",
      "options": [ { "t": "5 × 10³", "emoji": "🧩", "correct": true }, { "t": "5 × 10²", "feedback": "5 × 10² = 500 (só 2 zeros). 5000 tem 3 zeros: 5 × 10³.", "tag": "potencia-calculo" }, { "t": "50 × 10", "feedback": "50 × 10 = 500, não 5000. Com potência de 10 fica 5 × 10³.", "tag": "potencia-calculo" } ],
...
```quiz
{
  ...
  "questions": [
    { "q": "Numa potência, o número que se repete é a…", "layout": "grid",
      "options": [ { "t": "base", "emoji": "🔟", "correct": true }, { "t": "expoente", "feedback": "O expoente diz quantas vezes repetes. O número que se repete chama-se base.", "tag": "potencia-base-expoente" }, { "t": "soma", "feedback": "Soma é o resultado de uma adição. Numa potência, o número repetido é a base.", "tag": "potencia-base-expoente" } ],
      "explain": "A base é o número repetido; o expoente diz quantas vezes." },
    { "q": "Quanto é 10³?", "layout": "grid",
      "options": [ { "t": "1000", "emoji": "💯", "correct": true }, { "t": "30", "feedback": "30 seria 10 × 3. O expoente conta zeros: 10³ tem 3 zeros = 1000.", "tag": "potencia-vs-multiplicacao" }, { "t": "300", "feedback": "300 tem só 2 zeros (é 3 × 100). 10³ é 10 × 10 × 10 = 1000.", "tag": "potencia-calculo" } ],
      "explain": "3 zeros → 1000." },
    { "q": "10² é o mesmo que…", "layout": "grid",
      "options": [ { "t": "100", "correct": true }, { "t": "10 × 2", "feedback": "10 × 2 = 20. O expoente não multiplica por 2; repete o 10 duas vezes: 10 × 10 = 100.", "tag": "potencia-vs-multiplicacao" }, { "t": "12", "feedback": "12 seria 10 + 2. 10² é 10 × 10 = 100.", "tag": "potencia-vs-multiplicacao" } ],
      "explain": "10 × 10 = 100, não 10 × 2." },
    { "q": "Nas potências de 10, o expoente diz…", "layout": "grid",
      "options": [ { "t": "o número de zeros", "emoji": "🪄", "correct": true }, { "t": "o número de algarismos pares", "feedback": "Não tem nada a ver com pares. Nas potências de 10, o expoente é o número de zeros: 10⁴ = 10 000.", "tag": "potencia-calculo" } ],
      "explain": "10⁴ = 10 000 → 4 zeros." },
    { "q": "Quanto é 10¹?", "layout": "grid",
      "options": [ { "t": "10", "emoji": "🔟", "correct": true }, { "t": "1", "feedback": "1 é 10⁰ (elevado a 0). Elevado a 1, qualquer número fica igual: 10¹ = 10.", "tag": "potencia-casos-especiais" }, { "t": "100", "feedback": "100 é 10² (2 zeros). 10¹ tem só 1 zero: é o próprio 10.", "tag": "potencia-casos-especiais" } ],
      "explain": "Qualquer número elevado a 1 é ele próprio." },
    { "q": "Quanto é 3 × 10³ + 5 × 10²?", "layout": "grid",
      "options": [ { "t": "3500", "emoji": "🧩", "correct": true }, { "t": "350", "feedback": "Trocaste os expoentes por um a menos. 3 × 1000 + 5 × 100 = 3000 + 500 = 3500.", "tag": "potencia-decompor" }, { "t": "3050", "feedback": "Puseste o 5 nas dezenas. 5 × 10² são 500 (centenas): 3000 + 500 = 3500.", "tag": "potencia-decompor" } ],
      "explain": "3 × 1000 + 5 × 100 = 3000 + 500 = 3500." },
    { "q": "Quanto é 4 × 10³ + 2 × 10² + 7?", "layout": "grid",
      "options": [ { "t": "4207", "emoji": "🧱", "correct": true }, { "t": "427", "feedback": "Faltou um zero no 4 × 10³ (são 4000, não 400). 4000 + 200 + 7 = 4207.", "tag": "potencia-decompor" }, { "t": "4027", "feedback": "Puseste o 2 nas dezenas. 2 × 10² são 200 (centenas): 4000 + 200 + 7 = 4207.", "tag": "potencia-decompor" } ],
      "explain": "4000 + 200 + 7 = 4207." },
    { "q": "Quanto é 3,5 × 10² (com vírgula)?", "layout": "grid",
      "options": [ { "t": "350", "emoji": "💶", "correct": true }, { "t": "35", "feedback": "× 10² anda 2 casas, não 1. 3,5 vira 350.", "tag": "potencia-multiplicar" }, { "t": "3500", "feedback": "3500 seria andar 3 casas (× 10³). × 10² anda 2: 3,5 × 100 = 350.", "tag": "potencia-multiplicar" } ],
      "explain": "× 100: a vírgula anda 2 casas para a direita → 350." },
    { "q": "Os cientistas escrevem números enormes com…", "layout": "grid",
      "options": [ { "t": "notação científica (potências de 10)", "emoji": "🌌", "correct": true }, { "t": "muitos zeros à mão", "feedback": "Escrever todos os zeros à mão é trabalhoso e fácil de errar. Usam a notação científica: 1,5 × 10¹¹.", "tag": "potencia-notacao-cientifica" } ],
