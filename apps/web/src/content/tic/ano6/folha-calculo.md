...
> [!NOTE] **O que vais aprender** 👀 Vais aprender o básico de uma folha de cálculo: células, linhas, colunas, tabelas, somas e gráficos simples.

Uma folha de cálculo ajuda a organizar números e transformar dados em informação.
...
```chart
{ "title": "Livros lidos por mês", "type": "bar", "labels": ["Jan", "Fev", "Mar"], "data": [3, 5, 4] }
```

```steps
[
  { "title": "1. Criar tabela", "body": "Escreve títulos: mês e livros lidos." },
  { "title": "2. Preencher dados", "body": "Coloca os números nas células certas." },
  { "title": "3. Somar", "body": "Usa uma fórmula ou calcula o total." },
  { "title": "4. Fazer gráfico", "body": "Escolhe barras para comparar melhor." }
]
```
...
```quiz
{
  ...
  "questions": [
    ...
    { "q": "Uma fórmula serve para…", "layout": "grid",
      "options": [ { "t": "calcular automaticamente", "emoji": "🧮", "correct": true }, { "t": "pintar paredes" }, { "t": "desligar a internet" } ],
      "explain": "Fórmulas ajudam a fazer contas." },
