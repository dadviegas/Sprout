...
> [!TIP] **ter** é o verbo que mais usamos para dizer o que é nosso — e é irregular! **trazer** também.
...
```verbs
{
  ...
  "verbs": [
    ...
    { "verb": "tentar", "meaning": "Fazer um esforço para conseguir algo." },
    { "verb": "terminar", "emoji": "🏁", "meaning": "Chegar ao fim." },
    { "verb": "ter", "emoji": "✋", "meaning": "Ser dono de algo, ou sentir alguma coisa.",
      "forms": {
    ...
    { "verb": "trazer", "emoji": "📦", "meaning": "Levar uma coisa para o lugar onde estás.",
      "forms": {
        ...
        "imperativo": ["traz", "tragamos", "trazei"]
      } },
